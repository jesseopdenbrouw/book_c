...
Naast de genoemde datatypes bestaan er nog andere een datatypes: \texttt{bool}\index{bool} kan de waarde \texttt{true} of \texttt{false} bevatten en \texttt{complex}\index{complex} kan een complex getal bevatten.
