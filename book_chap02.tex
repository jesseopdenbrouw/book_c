...
Een veel gebruikt datatype is de \textsl{pointer}\index{pointer}. Een pointer is een variabele die het \textsl{adres}\index{adres} bevat van een (andere) variabele. Pointers worden in detail besproken in hoofdstuk~\ref{cha:pointers}.
...
De volgende operatoren worden verderop in het boek besproken:
