...
Hoofdstuk~\ref{cha:arrays} gaat over array's. We tonen hoe een array wordt gedeclareerd en kan worden gebruikt. We laten zien hoe array's als argument aan functies kan worden meegegeven.
...
Hoofdstuk~\ref{cha:preprocessor} gaat over de preprocessor. De preprocessor is een faciliteit die vóór de ``echte'' C-compiler wordt gebruikt. We laten zien hoe we header-bestanden kunnen inlezen en hoe we macro's kunnen definiëren.

Hoofdstuk~\ref{cha:compilatieproces} gaat over het compilatieproces. We bespreken hoe het compileerproces in elkaar steekt en wat er allemaal bij komt kijken voordat een uitvoerbaar programma is gerealiseerd.
...
Ik wil collega Harry Broeders van Hogeschool Rotterdam en collega Kees de Joode
bedanken voor hun bijdrage aan de totstandkoming van dit boek.
