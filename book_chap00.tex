...
Het boek is opgemaakt in \LaTeX{} (\LaTeX-engine = \booktexbanner). Gebruik voor het typesetten van dit boek een volledig lokaal ge\"installeerde distributie zoals TexLive of MikTeX. Download de broncode van het boek. Daarna is het boek te typesetten. Handig is om een \LaTeX-editor te gebruiken, zoals TeXstudio of TeXmaker.
