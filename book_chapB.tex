...
\includegraphics[width=\textwidth]{images/100installworkload}};
\draw[red,thick,rounded corners=5pt] (-7.25,-2.75) rectangle ++(4.75,1.1);
\end{tikzpicture}
...
Er wordt een nieuw scherm geopend, zie figuur~\ref{fig:102create}. Klik daarin op het kader \texttt{Empty Project}. \textbf{Klik niet op\texttt{ Console App}.}
...
\begin{tikzpicture}
\node[inner sep=0pt] (A) at (0,0) {
\includegraphics[scale=\figscaleH]{images/105enterfilename}};
\draw[red,thick,rounded corners=5pt] (-5.25,-3.75) rectangle ++(1.5,0.5);
\end{tikzpicture}
\caption{Gegevens van het C-bestand invullen.}
