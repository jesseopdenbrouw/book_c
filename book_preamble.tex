...
\lstset{%
  ...
  title=\lstname,
  upquote=true,
  aboveskip=1.3\baselineskip plus 3pt minus 3 pt,
  belowskip=0.2\baselineskip plus 3pt minus 3 pt,
  xleftmargin=1.5em,
  xrightmargin=1.5em,
  escapeinside={(*}{*)},
}
...
\newtcolorbox{remarkbox}[1][]{title=#1,colback=infoboxbg,colframe=bookcolor,fonttitle=\large\scshape,colbacktitle=infoboxbgtitle,coltitle=black,toptitle=5pt,bottomtitle=5pt,sharp corners,boxrule=2pt,titlerule=0pt,top=7pt,parbox=false,floatplacement=!b,float=!b}
