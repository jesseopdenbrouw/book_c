...
\booklistingfromproject[]{C}{Een functie met een static variabele}{static_local}{c}{!ht}
...
\booklistingfromproject[linerange={1-10,17-39}]{C}{Programma om Fibonacci-getallen af te drukken}{fibonacci_recursive}{c}{!ht}
...
\booklistingfromproject[]{C}{classificatie van karakters}{classificationcharacters}{c}{!ht}