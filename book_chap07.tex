...
Hierin wordt \texttt{artikel} de \textsl{structure identifier}\index{structure identifier} genoemd. De variabelen binnen de structure worden \textsl{leden} genoemd maar we zullen gebruik maken van de Engelse naam \textsl{members}\index{member}\index{structure!member}\indexkeyword{struct}.
