...
Een welhaast klassiek voorbeeld van een structure is een aantal artikelen. Van de artikelen geven we het artikelnummer, de naam, het aantal dat beschikbaar is en de prijs per stuk op. We definiëren de structure \texttt{artikel} als volgt (listing~\ref{cod:struct1}).

% We gebruiken label=cod:struct1 om de standaard label te wijzigen
\booklistingfromproject[linerange={6-11},label=cod:struct1]{C}{De structure \texttt{artikel}}{struct_artikel}{c}{!ht}
